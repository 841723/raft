...
const (
	// hosts
	MAQUINA1_LOCAL = "127.0.0.1"
	MAQUINA2_LOCAL = "127.0.0.1"
	MAQUINA3_LOCAL = "127.0.0.1"

	//puertos
	PUERTOREPLICA1_LOCAL = "29001"
	PUERTOREPLICA2_LOCAL = "29002"
	PUERTOREPLICA3_LOCAL = "29003"
...
func (cfg *configDespliegue) SinAcuerdoPorFallos(t *testing.T) {
	...
	cfg.t.Log("se comprometen entradas solo con 1 replicas")
